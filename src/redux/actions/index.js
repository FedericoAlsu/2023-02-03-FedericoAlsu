...
// Donde :id, es el id recibido como argumento de la action creator.
// Ojo con hacer un console.log de la respuesta desde el back. En nuestro reducer esperamos un objeto.
export const getTeamDetail = (id,dispatch) => {
   return dispatch => {
      return axios.get("http://localhost:3001/teams/"+id)
      .then((response)=>{
         dispatch({
